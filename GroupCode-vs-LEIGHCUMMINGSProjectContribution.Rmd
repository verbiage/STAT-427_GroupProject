...
```{r}
"Since she decided to leave our group, we thought we show her code versions vs our code for the same tasks (that she was originally assigned) - here our are results"
```
